...
typedef struct InternalInstruction {
  ...
  uint8_t displacement_raw_size; // size of raw bytes of displacement
  uint8_t immediateOffset[2];    // some instruction may have 2 immediates
  uint8_t immediateSizeRead[2];  // Size of immediate read, in bytes.
