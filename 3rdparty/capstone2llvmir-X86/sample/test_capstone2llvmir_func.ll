; ModuleID = 'test_capstone2llvmir_func'
source_filename = "test_capstone2llvmir_func"
...
entry:
  ...
  %4 = add i32 %3, 8
  store i32 %4, i32* @esp
  call void @ret_8(i32 %2)
  ret void
}

declare void @1(i32)

declare void @ret_8(i32)

declare void @2(i32)

declare void @3(i1, i32)

declare void @4(i3, x86_fp80)

declare x86_fp80 @5(i3)
